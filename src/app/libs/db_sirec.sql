...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Tabla de los organismos para los funcionarios.';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Tabla de grupos para los funcionarios.';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Tabla de rangos para los funcionarios.';
...
CREATE TABLE `tbl_asignaciones` (
  `id_asignacion` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT 'ID de la asignación.',
  `id_radio` int(11) NOT NULL COMMENT 'ID del radio que se está asignando al funcionario.',
  `id_funcionario` int(11) NOT NULL COMMENT 'ID del funcionario al que pertenece la asignación.',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Fecha y hora en que se creó la asignación.',
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT 'Fecha y hora en que se actualizó la última vez alguna información de la asignación.',
  -- FOREIGN KEYS
  FOREIGN KEY (`id_radio`) REFERENCES `tbl_radios`(`id_radio`),
  FOREIGN KEY (`id_funcionario`) REFERENCES `tbl_funcionarios`(`id_funcionario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Tabla de las asignaciones.';
